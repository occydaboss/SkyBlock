...
{
    public static final ItemStack enchDiamond = new ItemBuilder(Material.DIAMOND).setGlow(true).setDisplayName(ChatColor.AQUA + "Enchanted Diamond").build();
    ...
    public static ItemStack bobSummon ()
    {
        ItemStack i = new ItemBuilder(Material.ROTTEN_FLESH).setDisplayName(ChatColor.AQUA + "" + ChatColor.BOLD + "Enchanted Flesh").setGlow(true).setLore(ChatColor.WHITE + "Summons Bob").setAmount(1).build();
        return i;
    }

    public static ItemStack bobSword ()
    {
        ItemStack i = new ItemBuilder(Material.DIAMOND_SWORD).setDisplayName(ChatColor.AQUA + "" + ChatColor.BOLD + "Sword of the Undead").addItemFlag(ItemFlag.HIDE_UNBREAKABLE).setUnbreakable(true).setGlow(true).build();
