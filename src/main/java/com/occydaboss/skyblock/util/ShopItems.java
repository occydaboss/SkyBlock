...
public class ShopItems
{
    ...
    public static ItemStack levelUpButton (Player player)
    {
        ...
        {
            if (Level.getSubLevel(player, "mining") >= 100 && Level.getSubLevel(player, "farming") >= 100)
            {
        ...
        {
            if (Level.getSubLevel(player, "mining") >= 1000 && Level.getSubLevel(player, "farming") >= 1000)
            {
                return levelUpButton;
            }
            else
    ...
    public static ItemStack miningXP (Player player)
    {
        ...
        if (Level.getPlayerLevel(player) == 0)
        {
            ...
            {
                item = new ItemBuilder(Material.GOLDEN_PICKAXE).setDisplayName(ChatColor.YELLOW + "Mining XP: " + Level.getSubLevel(player, "mining")).setLore(ChatColor.WHITE + "Get Mining XP by breaking Cobblestone").addItemFlag(ItemFlag.HIDE_ATTRIBUTES).build();
            }
        }
        else if (Level.getPlayerLevel(player) == 1)
        {
            ...
            {
                item = new ItemBuilder(Material.GOLDEN_PICKAXE).setDisplayName(ChatColor.YELLOW + "Mining XP: " + Level.getSubLevel(player, "mining")).setLore(ChatColor.WHITE + "Get Mining XP by breaking Cobblestone and Sandstone").addItemFlag(ItemFlag.HIDE_ATTRIBUTES).build();
            }
        }
    ...
    public static ItemStack farmingXP (Player player)
    {
        ...
        if (Level.getPlayerLevel(player) == 0)
        {
            ...
            {
                item =new ItemBuilder(Material.WHEAT).setDisplayName(ChatColor.YELLOW + "Farming XP: " + Level.getSubLevel(player, "farming")).setLore(ChatColor.WHITE + "Get Farming XP by breaking Melons and Pumpkins").build();
            }
        }
        else if (Level.getPlayerLevel(player) == 1)
        {
            ...
            {
                item =new ItemBuilder(Material.WHEAT).setDisplayName(ChatColor.YELLOW + "Farming XP: " + Level.getSubLevel(player, "farming")).setLore(ChatColor.WHITE + "Get Farming XP by breaking Sugar Cane, Melons, and Pumpkins").build();
            }
        }
    ...
    public static ItemStack combatXP (Player player)
    {
        ...
        {
            if (Level.getSubLevel(player, "combat") == 1)
            {
